...
return [
    ...
    'color' => "Color",
    'comma' => "Comma",
    'comment_not_found' => "Message could not be found",
    'comment' => "Message",
    'comments' => "Messages",
    ...
    'event_posted_a_comment' => "Posted a new Message",
    ...
    'events_such_as' => "Events include: Messages, file uploads, payments, invoices, etc",
    'everyone' => "Everyone",
    ...
    'milestone_is_not_empty' => "Milestone has linked Task. You must first move them",
    ...
    'setting_welcome_message' => "Manage iProtect Staff Monitoring Settings",
    'settings' => "Settings",
    ...
    'task_collaboration_info' => "Assigned users will be able to view and participate (Message, attach files, etc) in other users tasks",
    ...
    'template_lang_lead_comment' => "Lead Message",
    ...
    'template_lang_project_comment' => "Project Message",
    ...
    'template_lang_task_comment' => "Task Message",
    ...
    'the_invoice_will_be_sent_to_customer' => "The invoice will be visible on client's bills page",
    'theme' => "Theme",
