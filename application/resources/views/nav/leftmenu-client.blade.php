        ...
        <nav class="sidebar-nav">
            <ul data-modular-id="main_menu_client" id="sidebarnav">
                ...
                @if(auth()->user()->is_client_owner)
                   ...
                   <li data-modular-id="main_menu_client_billing"
                    class="sidenav-menu-item {{ $page['mainmenu_client_billing'] ?? '' }}">
                            <a href="/invoices"
                                class="waves-effect waves-dark"><i class="ti-wallet"></i>{{ cleanLang(__('lang.invoices')) }}</a>
                        </li>
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu {{ $page['submenu_estimates'] ?? '' }}" id="submenu_estimates" style="display: none!important">
                            <a href="/estimates"
                ...
                <li data-modular-id="main_menu_client_users"
                    ...
                    title="{{ cleanLang(__('lang.users')) }}" style="display: none!important">
