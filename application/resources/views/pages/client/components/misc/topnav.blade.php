                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  tabs-menu-item {{ $page['tabmenu_timeline'] ?? '' }}"
                            ...
                            role="tab">Project {{ cleanLang(__('lang.timeline')) }}</a>
                    </li>
                    <!--details-->
                    ...
                    <!--files-->
                    <li style="display: none;" class="nav-item dropdown {{ $page['tabmenu_files'] ?? '' }}">
                    ...
                    <li class="nav-item dropdown {{ $page['tabmenu_financial'] ?? '' }}">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" id="fx-client-misc-topnave-billing">
                            ...
                            <!--[payments]-->
                            <a style="display: none;"class="dropdown-item js-dynamic-url  js-ajax-ux-request {{ $page['tabmenu_invoices'] ?? '' }}"
                                data-toggle="tab" data-loading-class="loading-tabs"
                                data-loading-target="embed-content-container"
                            ...
                            <!--[timesheets]-->
                            <a style="display: none;" class="dropdown-item js-dynamic-url  js-ajax-ux-request {{ $page['tabmenu_timesheets'] ?? '' }}"
                                data-toggle="tab" data-loading-class="loading-tabs"
                                data-loading-target="embed-content-container"
