...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
        ...
        <div id="list-page-actions">
                ...
                <!--send email-->
                <button style="display: none;" type="button" title="{{ cleanLang(__('lang.email_client')) }}" id="clientSendEmail"
                ...
                <span class="dropdown">
                        <button style="display: none;" type="button" data-toggle="dropdown" title="{{ cleanLang(__('lang.edit')) }}"
                ...
                <!--delete-->
                <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_client')) }}"
