...
<div class="card">
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div>
            ...
            <small class="text-muted" style="display: none;">{{ cleanLang(__('lang.telephone')) }}</small>
            ...
            <small class="text-muted" style="display: none;">{{ cleanLang(__('lang.category')) }}</small>
            ...
            <small class="text-muted" style="display: none;">{{ cleanLang(__('lang.tags')) }}</small>
