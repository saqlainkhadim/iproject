...
<tr id="contact_{{ $contact->id }}">
    ...
    <td class="contacts_col_action actions_column" id="contacts_col_action_{{ $contact->id }}">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button style="display: none;" type="button" title="{{ cleanLang(__('lang.delete')) }}"
            ...
            <span style="display: none;" class="btn btn-outline-default btn-circle btn-sm disabled {{ runtimePlaceholdeActionsButtons() }}"
                data-toggle="tooltip" title="{{ cleanLang(__('lang.actions_not_available')) }}"><i
                    class="sl-icon-trash"></i></span>
            @endif
            <!--edit-->
            @if(config('visibility.action_buttons_edit'))
            <button style="display: none;" type="button" title="{{ cleanLang(__('lang.edit')) }}"
            ...
            <!--send email-->
            <button type="button" style="display: none;" title="@lang('lang.send_email')"
