        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-sm-12 col-lg-8 text-left p-t-5">
                <input type="checkbox" id="settings2_file_folders_manage_assigned"
                    name="settings2_file_folders_manage_assigned" class="filled-in chk-col-light-blue" {{ runtimePrechecked($settings->settings2_file_folders_manage_assigned ?? '') }}>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-sm-12 col-lg-8 text-left p-t-5">
                <input type="checkbox" id="settings2_file_folders_manage_project_manager"
                    name="settings2_file_folders_manage_project_manager" class="filled-in chk-col-light-blue" {{ runtimePrechecked($settings->settings2_file_folders_manage_project_manager ?? '') }}>
        ...
        <div class="form-group form-group-checkbox row">
            ...
            <div class="col-sm-12 col-lg-8 text-left p-t-5">
                <input type="checkbox" id="settings2_file_folders_manage_client"
                    name="settings2_file_folders_manage_client" class="filled-in chk-col-light-blue" {{ runtimePrechecked($settings->settings2_file_folders_manage_client ?? '') }}>
