        ...
        <div class="grid-card-content project-card">
            ...
            <div class="x-meta p-t-15">
                ...
                <div class="projects_col_start_date p-l-3">
                    <span><strong>Date Started:</strong> {{ runtimeDate($project->project_created) }}</span>
                </div>

                <!--DUE DATE-->
                <div class="projects_col_end_date p-l-3">
                    <span><strong>Estimated/Delivery Date:</strong> {{ runtimeDate($project->project_date_due) }}</span>
                </div>
