    ...
    <div class="col-lg-12">
        ...
        <div class="hidden" id="edit_project_description_toggle">
            ...
            <textarea id="project_description" name="project_description"
                class="tinymce-textarea" row="2">{{ $project->project_description ?? '' }}</textarea>
        ...
        <div id="edit_category_and_users">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">{{ cleanLang(__('lang.assigned')) }} Staff</label>
                <div class="col-sm-12 col-lg-9">
