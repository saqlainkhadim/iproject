...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.show_archive_projects')) }}"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.my_projects')) }}"
        ...
        <!--layout toggle-->
        <span class="dropdown">
            <button style="display: none;" type="button" data-toggle="dropdown" title="@lang('lang.view_layout')" aria-haspopup="true"
                aria-expanded="false"
