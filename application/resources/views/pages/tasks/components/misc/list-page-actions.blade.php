...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.show_archive_tasks')) }}"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.my_tasks')) }}"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.quick_stats')) }}"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.kanban_view')) }}"
        ...
        <button type="button" style="display: none;" data-toggle="tooltip" title="{{ cleanLang(__('lang.filter')) }}"
