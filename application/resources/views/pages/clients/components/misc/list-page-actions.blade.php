...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right {{ $page['list_page_actions_size'] ?? '' }} {{ $page['list_page_container_class'] ?? '' }}"
    ...
    <div id="list-page-actions">
        ...
        <button style="display:none;" type="button" title="{{ cleanLang(__('lang.import_clients')) }}" id="clients-import-button"
        ...
        <button style="display:none;" type="button" data-toggle="tooltip" title="@lang('lang.export_clients')"
        ...
        <button style="display:none;" type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.filter')) }}"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark js-toggle-side-panel"
