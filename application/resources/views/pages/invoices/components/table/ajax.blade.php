...
<tr id="invoice_{{ $invoice->bill_invoiceid  }}">
    ...
    <td  class="invoices_col_payments" id="invoices_col_payments_{{ $invoice->bill_invoiceid }}" style="display:none;">
        <a
            href="{{ url('payments?filter_payment_invoiceid='.$invoice->bill_invoiceid) }}">{{ runtimeMoneyFormat($invoice->sum_payments) }}</a>
    </td>
    @endif
    <td class="invoices_col_balance hidden" id="invoices_col_balance_{{ $invoice->bill_invoiceid }}" style="display:none;">
        {{ runtimeMoneyFormat($invoice->invoice_balance) }}
    </td>
    <td class="invoices_col_status" id="invoices_col_status_{{ $invoice->bill_invoiceid }}" style="display:none;">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    ...
                    <a style="display: none;" class="dropdown-item" href="{{ url('/invoices/'.$invoice->bill_invoiceid.'/pdf') }}" download>
