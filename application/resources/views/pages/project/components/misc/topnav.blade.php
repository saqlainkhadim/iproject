<div class="row">
            ...
            <li data-modular-id="project_tabs_menu_financial"
                ...
                <a class="nav-link dropdown-toggle  tabs-menu-item" data-loading-class="loading-tabs"
                  ...
                  <!--[timesheets]-->
                    ...
                    <a class="nav-link dropdown-toggle  tabs-menu-item  js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_timesheets'] ?? '' }}"
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <a class="dropdown-item   js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_estimates'] ?? '' }}"
                        ...
                        href="#projects_ajaxtab" role="tab"  style="display: none;">{{ cleanLang(__('lang.estimates')) }}</a>
                    @endif
                    <!--[payments]-->
                    ...
                    <a class="dropdown-item   js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_invoices'] ?? '' }}"
                        ...
                        href="#projects_ajaxtab" role="tab"  style="display: none;">{{ cleanLang(__('lang.payments')) }}</a>
                    @endif
                    <!--[expenses]-->
                    ...
                    <a class="dropdown-item   js-dynamic-url js-ajax-ux-request {{ $page['tabmenu_invoices'] ?? '' }}"
                        ...
                        href="#projects_ajaxtab" role="tab"  style="display: none;">{{ cleanLang(__('lang.expenses')) }}</a>
                    @endif
  ...
  <!--[files]-->
            ...
            <!--[MODULES]-->
            <li data-modular-id="project_tabs_menu_more" class="nav-item dropdown {{ $page['tabmenu_more'] ?? '' }}" style="display: none;">
                <a class="nav-link dropdown-toggle  tabs-menu-item" data-loading-class="loading-tabs"
                    data-toggle="dropdown" href="javascript:void(0)" role="button" aria-haspopup="true"
