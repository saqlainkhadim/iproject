...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.reminder')) }}"
            ...
            data-target="reminders-side-panel" data-title="@lang('lang.my_reminder')"  style="display: none;">
        ...
        <button type="button"  style="display: none;" title="{{ cleanLang(__('lang.assigned_users')) }}"
        ...
        <span class="dropdown">
            <button style="display: none;" type="button" data-toggle="dropdown" title="{{ cleanLang(__('lang.edit')) }}" aria-haspopup="true"
                aria-expanded="false"
        ...
        <!--delete-->
        <button type="button"  style="display: none;" data-toggle="tooltip" title="{{ cleanLang(__('lang.delete_project')) }}"
