...
<div class="card" id="project_details" data-progress="{{ $project->project_progress }}">
    ...
    <div class="card-body p-t-10 p-b-10" id="project_progress_container">
        ...
        <div class="d-flex no-block">
            <div class="align-self-end no-shrink">
                <div class="panel-label p-b-3" style="margin-bottom: 5px;"><b><b>Project {{ cleanLang(__('lang.progress')) }} Chart</b></div>
                <h5 class="m-b-0" style="margin-top: 15px;"></b></h5><br/>
                <!--[team]-->
                @if(auth()->user()->is_team)
                @if($project->project_progress_manually == 'yes')
                <center><h6 class="text-muted" style="display: none; font-size: 13px!important;">{{ cleanLang(__('lang.manually_set_progress')) }}</h6></center>
                @else
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="panel-label p-b-3">{{ cleanLang(__('lang.assigned')) }} Staff</div>
                <div>
