...
function sendItexmoSms($recipient, $message) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_POSTFIELDS => array('Email' => 'kringledofficial@gmail.com','Password' => 'kringled8400','ApiCode' => 'PR-KEEME741137_KL3S3','Recipients' => '["'. $recipient .'"]','Message' => "$message"),
    ));
    ...
    $jsondata['notification'] = array('type' => 'error', 'value' => __('lang.request_has_been_completed'));

    return $responseJson['Error'] == 0 ? new ResendResponse() : response()->json($jsondata);
