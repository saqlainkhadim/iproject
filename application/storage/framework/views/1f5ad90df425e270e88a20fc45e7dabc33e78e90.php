...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button style="display:none;" type="button" title="<?php echo e(cleanLang(__('lang.import_clients'))); ?>" id="clients-import-button"
        ...
        <button style="display:none;" type="button" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.export_clients'); ?>"
        ...
        <button style="display:none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.filter'))); ?>"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark js-toggle-side-panel"
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/clients/components/misc/list-page-actions.blade.php ENDPATH**/ ?>