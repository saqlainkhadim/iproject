<div class="col-lg-4  col-md-12">
    <div class="card">
        <div class="card card-body mailbox m-b-0">
            <h5 class="card-title" style="font-weight: bold;"><?php echo e(cleanLang(__('lang.projects'))); ?> Status</h5>
            <div class="message-center dashboard-projects-admin">
                <!-- not started -->
                <a href="https://iprotectph.online/projects">
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/home/admin/widgets/third-row/projects.blade.php ENDPATH**/ ?>