...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_projects'))); ?>"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.my_projects'))); ?>"
        ...
        <!--layout toggle-->
        <span class="dropdown">
            <button style="display: none;" type="button" data-toggle="dropdown" title="<?php echo app('translator')->get('lang.view_layout'); ?>" aria-haspopup="true"
                aria-expanded="false"
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/projects/components/misc/list-page-actions.blade.php ENDPATH**/ ?>