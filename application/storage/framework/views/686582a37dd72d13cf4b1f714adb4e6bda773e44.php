...
<aside class="left-sidebar" id="js-trigger-nav-team">
            ...
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <li data-modular-id="main_menu_team_clients"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_contacts'] ?? ''); ?>" id="submenu_contacts" style="display:none;">
                            <a href="/users"
                ...
                <li data-modular-id="main_menu_team_billing"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_products'] ?? ''); ?>" id="submenu_products" style="display: none!important;">
                            <a href="/products"
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/u967487462/domains/shsiinc.com/public_html/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>