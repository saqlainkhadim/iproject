                ...
                <ul class="nav nav-tabs profile-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link  tabs-menu-item <?php echo e($page['tabmenu_timeline'] ?? ''); ?>"
                            ...
                            role="tab">Project <?php echo e(cleanLang(__('lang.timeline'))); ?></a>
                    </li>
                    <!--details-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link  tabs-menu-item js-dynamic-url js-ajax-ux-request <?php echo e($page['tabmenu_contacts'] ?? ''); ?>"
                            ...
                            href="#clients_ajaxtab" role="tab">Account</a>
                    </li>
                    <!--projects-->
                    <li class="nav-item">
                    ...
                    <!--files-->
                    <li style="display: none;" class="nav-item dropdown <?php echo e($page['tabmenu_files'] ?? ''); ?>">
                    ...
                    <li class="nav-item dropdown <?php echo e($page['tabmenu_financial'] ?? ''); ?>">
                        ...
                        <div class="dropdown-menu" x-placement="bottom-start" id="fx-client-misc-topnave-billing">
                            ...
                            <!--[payments]-->
                            <a style="display: none;"class="dropdown-item js-dynamic-url  js-ajax-ux-request <?php echo e($page['tabmenu_invoices'] ?? ''); ?>"
                                data-toggle="tab" data-loading-class="loading-tabs"
                                data-loading-target="embed-content-container"
                            ...
                            <!--[timesheets]-->
                            <a style="display: none;" class="dropdown-item js-dynamic-url  js-ajax-ux-request <?php echo e($page['tabmenu_timesheets'] ?? ''); ?>"
                                data-toggle="tab" data-loading-class="loading-tabs"
                                data-loading-target="embed-content-container"
                ...
                </ul><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/client/components/misc/topnav.blade.php ENDPATH**/ ?>