...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9 <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.reminder'))); ?>"
        ...
        <?php endif; ?>
        <!--email invoice-->
        <button type="button" data-toggle="tooltip" title="Send SMS"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark confirm-action-info"
            href="javascript:void(0)" data-confirm-title="Send SMS"
        ...
        <!--add payment-->
        <button type="button" style="display: none;" title="<?php echo e(cleanLang(__('lang.add_a_payment'))); ?>" id="invoiceAddPaymentButton"
        ...
        <!--clone-->
        <span class="dropdown">
            <button type="button" style="display: none;" class="data-toggle-tooltip list-actions-button btn btn-page-actions waves-effect waves-dark 
        ...
        <?php if(config('visibility.modules.reminders')): ?>
        <button type="button" style="display: none;" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.reminder'))); ?>"
            id="reminders-panel-toggle-button"
            class="reminder-toggle-panel-button list-actions-button btn btn-page-actions waves-effect waves-dark js-toggle-reminder-panel ajax-request <?php echo e($bill->reminder_status); ?>"
            data-url="<?php echo e(url('reminders/start?resource_type=invoice&resource_id='.$bill->bill_invoiceid)); ?>"
            data-loading-target="reminders-side-panel-body" data-progress-bar='hidden'
        ...
        <!--Download PDF-->
        <a data-toggle="tooltip" style="display: none;" title="<?php echo e(cleanLang(__('lang.download'))); ?>" id="invoiceDownloadButton"
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/bill/components/misc/invoice/actions.blade.php ENDPATH**/ ?>