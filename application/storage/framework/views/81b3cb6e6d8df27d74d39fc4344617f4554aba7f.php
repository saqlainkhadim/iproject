            ...
            <table id="invoices-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="invoices_col_payments" style="display:none;"><a class="js-ajax-ux-request js-list-sorting"
                        ...
                        <?php endif; ?>
                        <th class="invoices_col_balance hidden" style="display:none;"><a class="js-ajax-ux-request js-list-sorting" id="sort_balance"
                                href="javascript:void(0)"
                        ...
                        <th class="invoices_col_status" style="display:none;"><a class="js-ajax-ux-request js-list-sorting"
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/invoices/components/table/table.blade.php ENDPATH**/ ?>