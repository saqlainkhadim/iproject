<div class="row" id="js-trigger-invoices-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
        ...
        <div class="client-selector">
            ...
            <!--option buttons-->
            <div class="client-selector-links" style="display: none;">
        ...
        <!--recurring notes-->
        <div  style="display:none;" class="alert alert-info m-t-10"><i class="sl-icon-refresh text-warning"></i>
            <?php echo e(cleanLang(__('lang.recurring_invoice_options_info'))); ?></div>
    </div>
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>