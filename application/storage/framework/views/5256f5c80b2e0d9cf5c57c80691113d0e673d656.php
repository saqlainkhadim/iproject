...
<tr id="invoice_<?php echo e($invoice->bill_invoiceid); ?>">
    ...
    <td  class="invoices_col_payments" id="invoices_col_payments_<?php echo e($invoice->bill_invoiceid); ?>" style="display:none;">
        <a
    ...
    <?php endif; ?>
    <td class="invoices_col_balance hidden" id="invoices_col_balance_<?php echo e($invoice->bill_invoiceid); ?>" style="display:none;">
        <?php echo e(runtimeMoneyFormat($invoice->invoice_balance)); ?>

    </td>
    <td class="invoices_col_status" id="invoices_col_status_<?php echo e($invoice->bill_invoiceid); ?>" style="display:none;">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    <?php if(config('visibility.action_buttons_edit')): ?>
                    <!--quick edit-->
                    <a style="display: none;" class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button"
                    ...
                    <!--email to client-->
                    <a style="display: none;" class="dropdown-item confirm-action-info" href="javascript:void(0)"
                    ...
                    <?php endif; ?>
                    <!--change category-->
                    <a style="display: none;" class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    <!--dettach project -->
                    <?php if(is_numeric($invoice->bill_projectid)): ?>
                    <a style="display: none;" class="dropdown-item confirm-action-danger" href="javascript:void(0)"
                    ...
                    <a style="display: none;" class="dropdown-item" href="<?php echo e(url('/invoices/'.$invoice->bill_invoiceid.'/pdf')); ?>" download>
...
<!--each row--><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>