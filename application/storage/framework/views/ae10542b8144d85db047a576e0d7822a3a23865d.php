...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_tasks'))); ?>"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.my_tasks'))); ?>"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.quick_stats'))); ?>"
        ...
        <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.kanban_view'))); ?>"
        ...
        <!--kanban task sorting-->
        <div class="btn-group" id="list_actions_sort_kanban"  style="display: none;">
            <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                class="list-actions-button btn waves-effect waves-dark dropdown-toggle"  style="display: none;">
        ...
        <button type="button" style="display: none;" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.filter'))); ?>"
        ...
        <a style="display: none;" id="fx-page-actions-add-button" type="button" class="btn btn-danger btn-add-circle edit-add-modal-button"
            href="<?php echo e($page['add_button_link_url'] ?? ''); ?>">
            <i class="ti-plus"></i>
        </a>
        <?php endif; ?>
    </div>
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/tasks/components/misc/list-page-actions.blade.php ENDPATH**/ ?>