    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <!-- record time -->
                <?php if(auth()->user()->is_staff && config('visibility.modules.timetracking')): ?>
                ...
                <li class="nav-item dropdown" id="topnav-language-icon" style="display: none!important;">
...
</header><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>