    ...
    <div class="col-lg-12">
        ...
        <div class="spacer row">
            <div class="col-sm-12 col-lg-8">
                <span class="title">Address and Contact Number</span class="title">
            </div>
        ...
        <div id="add_client_billing_address_section">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 col-lg-3 text-left control-label col-form-label">Mobile Number</label>
                <div class="col-sm-12 col-lg-9">
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/clients/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>