    ...
    <!--show timer-->
    <div id="task-timer-container" style="display: none;">
    ...
    <div class="x-section">
        ...
        <div style="display: none;" class="x-element" id="card-task-client-visibility"><i class="mdi mdi-eye"></i>
        ...
        <div class="card-reminders-container" id="card-reminders-container" style="display: none;">
    ...
    <!----------tags----------->
    <div class="card-tags-container" id="card-tags-container" style="display: none;">
    ...
    <!--dependencies-->
    <div class="x-section" style="display: none;">
        <div class="x-title">
    ...
    <div class="x-section">
        ...
        <div style="display: none;" class="x-element x-action confirm-action-danger"
        ...
        <div style="display: none;" class="x-element x-action confirm-action-info  <?php echo e(runtimeActivateOrAchive('archive-button', $task->task_active_state)); ?> card_archive_button_<?php echo e($task->task_id); ?>"
    ...
    </div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/task/rightpanel.blade.php ENDPATH**/ ?>