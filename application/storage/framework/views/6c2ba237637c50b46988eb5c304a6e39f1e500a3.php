...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
        ...
        <div id="list-page-actions">
                ...
                <!--send email-->
                <button style="display: none;" type="button" title="<?php echo e(cleanLang(__('lang.email_client'))); ?>" id="clientSendEmail"
                ...
                <span class="dropdown">
                        <button style="display: none;" type="button" data-toggle="dropdown" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                                aria-haspopup="true" aria-expanded="false"
                                class="data-toggle-tooltip list-actions-button btn btn-page-actions waves-effect waves-dark">
                                <i class="sl-icon-note"></i>
                        </button>

                        <div style="display: none;" class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <!--delete-->
                <button style="display: none;" type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_client'))); ?>"
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/client/components/misc/actions.blade.php ENDPATH**/ ?>