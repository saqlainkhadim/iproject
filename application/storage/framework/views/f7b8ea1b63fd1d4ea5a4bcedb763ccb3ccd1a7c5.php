<div class="invoice-item-actions">
    ...
    <button type="button" id="billing-item-actions-blank"
        ...
        <span>Add Specific Bill</span></button>

    <!--add time line-->
    <button style="display: none;" type="button" id="billing-time-actions-blank"
        class="btn btn-secondary btn-rounded btn-sm btn-rounded-icon"><i
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/bill/components/misc/add-line-buttons.blade.php ENDPATH**/ ?>