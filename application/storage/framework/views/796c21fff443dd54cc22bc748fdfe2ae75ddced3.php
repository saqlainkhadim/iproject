...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.reminder'))); ?>"
            ...
            data-target="reminders-side-panel" data-title="<?php echo app('translator')->get('lang.my_reminder'); ?>"  style="display: none;">
        ...
        <button type="button"  style="display: none;" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
        ...
        <span class="dropdown">
            <button style="display: none;" type="button" data-toggle="dropdown" title="<?php echo e(cleanLang(__('lang.edit'))); ?>" aria-haspopup="true"
                aria-expanded="false"
        ...
        <!--delete-->
        <button type="button"  style="display: none;" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.delete_project'))); ?>"
...
<!-- action buttons --><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>