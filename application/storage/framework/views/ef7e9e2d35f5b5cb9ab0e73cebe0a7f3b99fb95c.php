...
<div class="row">
    ...
    <option value="<?php echo e($user->position ?? ''); ?>">Manager</option>
    <option value="<?php echo e($user->position ?? ''); ?>">Team Leader</option>
    <option value="<?php echo e($user->position ?? ''); ?>">IT Staff</option>
  </select>
            </div>
        </div>
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/team/modals/add-edit-inc.blade.php ENDPATH**/ ?>