                ...
                <thead>
                    <tr>
                        <th class="team_col_first_name"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="<?php echo e(urlResource('/team?action=sort&orderby=first_name&sortorder=asc')); ?>">Full Name<span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                        <th class="team_col_position" style="display:none;"><a class="js-ajax-ux-request js-list-sorting" id="sort_position"
...
</div><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/team/components/table/table.blade.php ENDPATH**/ ?>