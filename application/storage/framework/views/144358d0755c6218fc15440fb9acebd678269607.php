<div id="js-projects-modal-add-edit" data-project-progress=" <?php echo e($project['project_progress'] ?? 0); ?>">
    <div class="form-group form-group-checkbox row">
        <label class="col-10 col-form-label text-left">Please indicate the percentage of project progress</label>
        <div class="col-2 text-left p-t-5"  style="display: none;">
    ...
    <div class="alert alert-info m-t-30" style="display: none;">
...
</script><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/projects/components/actions/change-progress.blade.php ENDPATH**/ ?>