...
<tr id="contact_<?php echo e($contact->id); ?>">
    ...
    <td class="contacts_col_action actions_column" id="contacts_col_action_<?php echo e($contact->id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button style="display: none;" type="button" title="<?php echo e(cleanLang(__('lang.delete'))); ?>"
            ...
            <span style="display: none;" class="btn btn-outline-default btn-circle btn-sm disabled <?php echo e(runtimePlaceholdeActionsButtons()); ?>"
            ...
            <button style="display: none;" type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
            ...
            <!--send email-->
            <button type="button" style="display: none;" title="<?php echo app('translator')->get('lang.send_email'); ?>"
...
<!--each row--><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/contacts/components/table/ajax.blade.php ENDPATH**/ ?>