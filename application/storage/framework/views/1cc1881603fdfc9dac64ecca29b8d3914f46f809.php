...
<aside class="left-sidebar settings-menu">
    ...
    <div class="scroll-sidebar" id="settings-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="settings-sidebar-nav">
            <ul id="sidebarnav">
                ...
                <!--clients-->
                <li class="sidenav-menu-item" style="display: none;">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="javascript:void(0);" data-url="/settings/webmail/templates"
                                ...
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"style="display: none;" ><?php echo e(cleanLang(__('lang.email_templates'))); ?></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li style="display: none;"><a href="javascript:void(0);" data-url="/settings/customfields/projects"
                                id="settings-menu-projects-forms"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.custom_form_fields'))); ?></a>
                        </li>
                        <li style="display: none;"><a class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li style="display: none;"><a href="javascript:void(0);" data-url="/settings/customfields/tasks"
                ...
                <!--leads-->
                <li class="sidenav-menu-item" style="display: none!important">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
                ...
                <!--contracts-->
                <li class="sidenav-menu-item hidden" style="display: none!important">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/u967487462/domains/iprotectph.online/public_html/application/resources/views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>